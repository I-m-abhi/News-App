...
const Navbar = ()=>{
  ...
  window.addEventListener('scroll',colorChange);
    ...
    return (
      <>
      <div>
        <nav className={navbar ? "navbar fixed-top active navbar-expand-lg" : 'navbar fixed-top  navbar-expand-lg '}>
        {/* <nav className={fixed ? "navbar  active navbar-expand-lg" : 'navbar fixed-top navbar-expand-lg '}> */}
